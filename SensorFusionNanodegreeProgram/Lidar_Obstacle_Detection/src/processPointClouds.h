...
public:
    ...
    void BuildKDtree(typename pcl::PointCloud<PointT>::Ptr cloud, KdTree<PointT>* tree);

    void ProximityScan(typename pcl::PointCloud<PointT>::Ptr cloud, std::vector<int>* cluster, std::vector<bool>* points_visited, KdTree<PointT>* tree, int point_idx, float distanceTol, int maxSize);
